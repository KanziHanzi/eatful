export {default as Text} from './globals/Text/Text';
export {default as Icon} from './globals/Icon/Icon';
export {default as ThemedText} from './globals/ThemedText/ThemedText';
export {default as ThemedView} from './globals/ThemedView/ThemedView';
